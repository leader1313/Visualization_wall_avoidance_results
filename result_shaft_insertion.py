...
class ShaftInsertion_VideoMaker(VideoMaker):
...
if __name__ == '__main__':
    ...
    MGP_BDI = torch.ones(300, 1) * MGP_level_X
    # Random sampling
    ...
    # videoMaker = ShaftInsertion_VideoMaker(
    #     video_name='ShaftInsertion/Homo')
    ...
    for i in range(10):
        videoMaker = ShaftInsertion_VideoMaker(
            video_name='ShaftInsertion/Hetero')
        get_fig = videoMaker.get_noisy_figure
